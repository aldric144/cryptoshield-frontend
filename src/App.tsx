  ...
  return (
    <div className="min-h-screen bg-[#0A1A2F] text-white">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <Button
                ...
                className="bg-[#14B8A6] hover:bg-[#14B8A6]/80 text-[#0A1A2F] font-bold h-12 px-6 text-base"
                disabled={isFinalizing}
              >
                {isFinalizing ? '⏳ Finalizing...' : '📁 Finalize Case + Start New Session'}
              </Button>
              {userSubscription && userSubscription.subscription_tier === 'free' && (
                <Button
                  onClick={() => setShowSubscriptionModal(true)}
                  className="bg-gradient-to-r from-[#14B8A6] to-purple-500 hover:opacity-90 text-white font-bold h-12 px-6 text-base shadow-[0_0_12px_#14B8A6]"
                >
                  🛡 Upgrade
                </Button>
              )}
              ...
              {nightModeActive && (
                <Badge variant="outline" className="border-[#FBBF24] text-[#FBBF24] text-base px-4 py-2">
                  🌙 NIGHT MODE
                </Badge>
              )}
              {travelModeActive && (
                <Badge variant="outline" className="border-[#14B8A6] text-[#14B8A6] text-base px-4 py-2">
                  ✈️ TRAVEL MODE
                </Badge>
              )}
              {stats && (
      ...
      {nearbyATM && isMonitoring && voiceAnalysis && voiceAnalysis.scam_probability > 50 && (
        <div className="bg-[#EF4444] border-b-4 border-[#7F1D1D] py-4">
          <div className="container mx-auto px-6">
            <div className="flex items-center gap-3">
              <AlertTriangle className="w-6 h-6 text-white animate-pulse" />
              <span className="text-xl font-bold text-white">
                🟥 DANGER — You are near a Bitcoin ATM during a suspicious call. STOP IMMEDIATELY.
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <Card className="bg-[#132B45] border-[#14B8A6]/30 border-2 rounded-[14px] p-8 hover:shadow-[0_0_12px_#14B8A6] transition-shadow">
              <CardHeader className="pb-6">
                ...
                <CardDescription className="text-[#CFFAFE] text-lg mt-2">
                  ...
                  {nightModeActive && <span className="ml-2 text-[#FBBF24]">🌙 Enhanced Night Protection Active</span>}
                </CardDescription>
              </CardHeader>
                ...
                {voiceAnalysis && (
                  <div className="space-y-6 mt-8">
                    ...
                    {threatLevel && (
                      <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[14px] p-6">
                        <CardHeader className="pb-4">
                          <CardTitle className="text-[#CFFAFE] text-xl font-bold flex items-center gap-3">
                            <span>🎯</span>
                            Threat Level Meter (Homeland Security Style)
                          </CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-5">
                          <div className="text-center">
                            ...
                            <Progress value={threatLevel.score} className="h-6 mb-4" />
                          ...
                          {threatLevel.contributing_factors.length > 0 && (
                            <div className="mt-6">
                              <div className="text-lg text-[#CFFAFE] mb-3 font-bold">Contributing Factors:</div>
                              <div className="space-y-2">
                                {threatLevel.contributing_factors.map((factor, idx) => (
                                  <div key={idx} className="flex items-center gap-2 text-white text-base bg-[#132B45] p-3 rounded-lg">
                    ...
                    {darkPatterns && darkPatterns.pattern_list.length > 0 && (
                      <Card className="bg-[#11243D] border-[#EF4444]/50 border-2 rounded-[14px] p-6">
                        <CardHeader className="pb-4">
                          <CardTitle className="text-[#EF4444] text-xl font-bold flex items-center gap-3">
                            <span>🔍</span>
                            Dark Pattern Voice Fingerprinting
                          </CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-5">
                          <div className="text-center mb-4">
                            ...
                            <div className="text-lg text-[#CFFAFE]">
                              Manipulation Score
                            </div>
                          </div>
                          <div className="space-y-3">
                            <div className="text-lg text-[#CFFAFE] font-bold">Detected Patterns:</div>
                            {darkPatterns.pattern_list.map((pattern, idx) => (
                              <div key={idx} className="flex items-center justify-between bg-[#132B45] p-3 rounded-lg">
                          ...
                          <div className="mt-4 p-3 bg-[#132B45] rounded-lg">
                            <div className="text-sm text-[#CFFAFE]">Fingerprint Hash:</div>
                            <div className="text-white font-mono text-xs mt-1">{darkPatterns.fingerprint_hash}</div>
                          </div>
                        </CardContent>
                      </Card>
                    )}
                    ...
                    {scammerProfile && (
                      <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[14px] p-6">
                        ...
                        <CardContent className="space-y-6">
                          <div>
                            <div className="text-lg text-[#CFFAFE] font-bold mb-3">🎙 Voice Traits</div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="bg-[#132B45] p-3 rounded-lg">
                                <div className="text-sm text-[#CFFAFE]">Accent</div>
                                <div className="text-white font-bold">{scammerProfile.voiceTraits.accent}</div>
                              </div>
                              <div className="bg-[#132B45] p-3 rounded-lg">
                                <div className="text-sm text-[#CFFAFE]">Speed</div>
                                <div className="text-white font-bold">{scammerProfile.voiceTraits.speed}</div>
                              </div>
                              <div className="bg-[#132B45] p-3 rounded-lg">
                                <div className="text-sm text-[#CFFAFE]">Pitch</div>
                                <div className="text-white font-bold">{scammerProfile.voiceTraits.pitch}</div>
                              </div>
                              <div className="bg-[#132B45] p-3 rounded-lg">
                                <div className="text-sm text-[#CFFAFE]">Dominance</div>
                                <div className="text-white font-bold">{scammerProfile.voiceTraits.dominance}</div>
                              </div>
                            </div>
                          </div>

                          <div>
                            <div className="text-lg text-[#CFFAFE] font-bold mb-3">🧠 Behavioral Patterns</div>
                            <div className="space-y-3">
                              <div>
                          ...
                          {scammerProfile.scriptPatterns.length > 0 && (
                            <div>
                              <div className="text-lg text-[#CFFAFE] font-bold mb-3">💬 Script Patterns</div>
                              <div className="flex flex-wrap gap-2">
                          ...
                          <div>
                            <div className="text-lg text-[#CFFAFE] font-bold mb-3">🔗 Financial Behavior</div>
                            <div className="bg-[#132B45] p-4 rounded-lg space-y-2">
                          ...
                          {scammerProfile.likelyNationality.likely_origins.length > 0 && (
                            <div>
                              <div className="text-lg text-[#CFFAFE] font-bold mb-3">🌍 Likely Nationality</div>
                              <div className="space-y-2">
                                {scammerProfile.likelyNationality.likely_origins.map((origin, idx) => (
                                  <div key={idx} className="flex items-center justify-between bg-[#132B45] p-3 rounded-lg">
                                    <span className="text-white font-bold">{idx + 1}. {origin.country}</span>
                                    <Badge className="bg-[#14B8A6] text-[#0A1A2F]">
                                      {origin.probability}%
                                    </Badge>
                                  </div>
                                ))}
                              </div>
                              <div className="mt-2 text-sm text-[#CFFAFE]">
                          ...
                          <div>
                            <div className="text-lg text-[#CFFAFE] font-bold mb-3">⚠ Scam Pattern Type</div>
                            <Badge className="bg-[#EF4444] text-white text-lg px-4 py-2">
                    ...
                    {sessionTimeline.length > 0 && (
                      <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[14px] p-6">
                        <CardHeader className="pb-4">
                          <CardTitle className="text-[#CFFAFE] text-xl font-bold flex items-center gap-3">
                            <span>📊</span>
                            Case Session Timeline (Forensic Track)
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                            ...
                            {sessionTimeline.map((event, idx) => (
                              <div key={idx} className={`flex items-start gap-4 p-4 rounded-lg border-l-4 ${
                                ...
                                <div className="flex-1">
                                  <div className="text-white font-bold text-base">{event.event}</div>
                                  <div className="text-[#CFFAFE] text-sm mt-1">{event.timestamp}</div>
                                </div>
                                <Badge className={`${
          ...
          {/* WALLET TAB - Enhanced with Scam Index and HOTMAP */}
          <TabsContent value="wallet" className="space-y-8">
            ...
            <Card className="bg-[#132B45] border-[#14B8A6]/30 border-2 rounded-[14px] p-8 hover:shadow-[0_0_12px_#14B8A6] transition-shadow">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-white text-base font-medium mb-2 block">Search By</label>
                    <select
                      value={walletSearchType}
                      onChange={(e) => setWalletSearchType(e.target.value as any)}
                      className="w-full bg-[#11243D] border-2 border-[#14B8A6]/30 text-white text-base h-12 rounded-[10px] px-4"
                    >
                  ...
                  <div>
                    <label className="text-white text-base font-medium mb-2 block">Search Query</label>
                    <div className="flex gap-2">
                      <Input
                        value={walletSearchQuery}
                        onChange={(e) => setWalletSearchQuery(e.target.value)}
                        placeholder={`Enter ${walletSearchType}...`}
                        className="bg-[#11243D] border-2 border-[#14B8A6]/30 focus:border-[#14B8A6] text-white placeholder:text-[#A1A1AA] text-base h-12 rounded-[10px]"
                      />
                      <Button 
                        onClick={searchScamWallets}
                        className="bg-[#14B8A6] hover:bg-[#14B8A6]/90 text-[#0A1A2F] font-bold h-12 px-6 rounded-[10px]"
                      >
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  {filteredScamWallets.map((wallet, idx) => (
                    <Card key={idx} className="bg-[#11243D] border-[#EF4444]/50 border-2 rounded-[12px] p-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <Badge className={`${getRiskBgColor(wallet.riskScore)} text-white text-base px-3 py-1`}>
                              Risk: {wallet.riskScore}%
                            </Badge>
                            <span className="text-[#CFFAFE] text-sm">ZIP: {wallet.zipCode}</span>
                          </div>
                          <div className="text-white font-mono text-sm mb-2">{wallet.address}</div>
                          <div className="text-[#E2E8F0] text-sm mb-2">
            ...
            <Card className="bg-[#132B45] border-[#14B8A6]/30 border-2 rounded-[14px] p-8 hover:shadow-[0_0_12px_#14B8A6] transition-shadow">
              ...
              <CardContent className="space-y-6">
                <div className="bg-[#11243D] border-2 border-[#14B8A6]/30 rounded-[14px] p-6">
                  <div className="text-[#CFFAFE] text-lg mb-4">High-Density Scam Zones</div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-[#EF4444]/20 rounded-lg">
                      <div>
                        <div className="text-white font-bold">San Francisco, CA (94103)</div>
                        <div className="text-[#E2E8F0] text-sm">37 active scam wallets | 28 ATM locations</div>
                      </div>
                      <Badge className="bg-[#EF4444] text-white">CRITICAL</Badge>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-[#FBBF24]/20 rounded-lg">
                      <div>
                        <div className="text-white font-bold">New York, NY (10001)</div>
                        <div className="text-[#E2E8F0] text-sm">42 active scam wallets | 35 ATM locations</div>
                      </div>
                      <Badge className="bg-[#FBBF24] text-[#0A1A2F]">HIGH</Badge>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-[#FBBF24]/20 rounded-lg">
                      <div>
                        <div className="text-white font-bold">Los Angeles, CA (90015)</div>
                        <div className="text-[#E2E8F0] text-sm">31 active scam wallets | 22 ATM locations</div>
                      </div>
                      <Badge className="bg-[#FBBF24] text-[#0A1A2F]">HIGH</Badge>
                    </div>
                  </div>
                    ...
                    <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[14px] p-6">
                      ...
                      <CardContent>
                        <div className="text-[#E2E8F0] text-base">
                          {JSON.stringify(walletRisk.risk_lineage_map, null, 2)}
                        </div>
                      </CardContent>
                    </Card>
                  </div>
          ...
          {/* GPS TAB - Enhanced with Forward/Reverse Geocoding and Store Locator */}
          <TabsContent value="gps" className="space-y-8">
            ...
            <Card className="bg-[#132B45] border-[#14B8A6]/30 border-2 rounded-[14px] p-8 hover:shadow-[0_0_12px_#14B8A6] transition-shadow">
              ...
              <CardContent className="space-y-6">
                <div>
                  <label className="text-white text-lg font-medium mb-3 block">Street Address</label>
                  <Input
                    value={searchAddress}
              ...
              <CardContent className="space-y-6">
                ...
                {currentAddress && (
                  <div className="bg-[#11243D] border-2 border-[#14B8A6]/30 rounded-[14px] p-6">
                    ...
                    <div className="text-xl text-white font-bold">{currentAddress}</div>
                ...
                {nearbyATM && (
                  <Alert className="bg-[#EF4444]/20 border-[#EF4444] border-2 p-6 rounded-[14px] pulse-glow">
                    <AlertTriangle className="h-6 w-6 text-[#EF4444]" />
                    <AlertTitle className="text-[#EF4444] font-bold text-2xl mb-4">
                    ...
                    <AlertDescription className="space-y-3">
                      ...
                      <div className="text-lg text-white">
                        <span className="text-[#CFFAFE]">Risk Level:</span> <Badge className="bg-[#EF4444] text-white ml-2">{nearbyATM.riskLevel}</Badge>
                      </div>
                ...
                {gpsCheck && gpsCheck.risk_detected && (
                  <Alert className="bg-[#FBBF24]/20 border-[#FBBF24] border-2 p-6 rounded-[14px]">
                    <AlertTriangle className="h-6 w-6 text-[#FBBF24]" />
                    <AlertTitle className="text-white font-bold text-xl">
              ...
              <CardContent className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <Button 
                    ...
                    className="bg-[#14B8A6] hover:bg-[#14B8A6]/90 text-[#0A1A2F] font-bold text-lg h-14 px-8 rounded-[12px] shadow-[0_0_12px_#14B8A6]"
                  >
                ...
                {highRiskStores.length > 0 && (
                  <div className="space-y-4">
                    <div className="text-lg text-[#CFFAFE] font-bold">
                      High-Risk Stores in ZIP {zipCode || 'All Areas'}:
                    </div>
                    {highRiskStores.map((store, idx) => (
                      <Card key={idx} className="bg-[#11243D] border-[#EF4444]/50 border-2 rounded-[12px] p-6">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <span className="text-2xl">{idx + 1}️⃣</span>
                              <div className="text-xl text-white font-bold">{store.name}</div>
                            </div>
                            <div className="text-base text-[#E2E8F0] mb-2">📍 {store.address}</div>
                          </div>
                          <Badge className={`${getRiskBgColor(store.riskScore)} text-white text-lg px-4 py-2`}>
                            {store.riskScore}%
                          </Badge>
                        </div>
                        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          {/* FAMILY TAB - Trusted Contacts System */}
          <TabsContent value="family" className="space-y-8">
            <Card className="bg-[#132B45] border-[#14B8A6]/30 border-2 rounded-[14px] p-8 hover:shadow-[0_0_12px_#14B8A6] transition-shadow">
              ...
              <CardContent className="space-y-6">
                ...
                {showAddContact && (
                  <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[12px] p-6">
                    <CardHeader className="pb-4">
                      <CardTitle className="text-[#CFFAFE] text-xl font-bold">New Contact</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-[#132B45] border-2 border-[#14B8A6]/30 focus:border-[#14B8A6] text-white placeholder:text-[#A1A1AA] text-base h-12 rounded-[10px]"
                        />
                      </div>
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-[#132B45] border-2 border-[#14B8A6]/30 text-white text-base h-12 rounded-[10px] px-4"
                        >
                      ...
                      <div className="flex gap-3 mt-4">
                        <Button 
                          ...
                          className="flex-1 bg-[#14B8A6] hover:bg-[#14B8A6]/90 text-[#0A1A2F] font-bold h-12 rounded-[10px]"
                        >
                          Save Contact
                        </Button>
                        <Button 
                          onClick={() => setShowAddContact(false)}
                          className="flex-1 bg-[#EF4444] hover:bg-[#EF4444]/90 text-white font-bold h-12 rounded-[10px]"
                        >
                          Cancel
                        </Button>
                      </div>
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  {trustedContacts.map((contact) => (
                    <Card key={contact.id} className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[12px] p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <div className="text-xl text-white font-bold">{contact.name}</div>
                            <Badge variant="outline" className={`${contact.active ? 'border-[#22C55E] text-[#22C55E]' : 'border-[#A1A1AA] text-[#A1A1AA]'} text-sm px-3 py-1`}>
                              {contact.active ? 'ACTIVE' : 'INACTIVE'}
                            </Badge>
                          </div>
                          <div className="text-base text-[#E2E8F0] mb-1">
                            <span className="text-[#CFFAFE]">Relationship:</span> {contact.relationship}
                          </div>
                          <div className="text-base text-[#E2E8F0] mb-1">
                            <span className="text-[#CFFAFE]">Phone:</span> {contact.phone}
                          </div>
                          <div className="text-base text-[#E2E8F0] mb-3">
                            <span className="text-[#CFFAFE]">Email:</span> {contact.email}
                          </div>
                          <div className="text-sm text-[#CFFAFE] mb-2">Notifications:</div>
                          <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex flex-col gap-2 ml-4">
                          <Button 
                            ...
                            className="bg-[#14B8A6] hover:bg-[#14B8A6]/90 text-[#0A1A2F] font-bold h-10 px-4 rounded-[8px] text-sm"
                          >
                            {contact.active ? 'Deactivate' : 'Activate'}
                          </Button>
                          <Button 
                            onClick={() => removeContact(contact.id)}
                            className="bg-[#EF4444] hover:bg-[#EF4444]/90 text-white font-bold h-10 px-4 rounded-[8px] text-sm"
                          >
                ...
                <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[12px] p-6">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-[#CFFAFE] text-xl font-bold flex items-center gap-2">
                      <Bell className="w-5 h-5" />
                      Notification Log
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2 text-base text-[#E2E8F0]">
              ...
              <CardContent className="space-y-6">
                {caseFiles.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <div className="text-xl text-[#E2E8F0]">No case files yet</div>
                  ...
                  <div className="space-y-4">
                    {caseFiles.map((caseFile) => (
                      <Card key={caseFile.id} className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[12px] p-6">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <span className="text-2xl">📁</span>
                              <div className="text-xl text-white font-bold">Case #{caseFile.id.split('-')[1]}</div>
                              <Badge className={`${getRiskBgColor(caseFile.riskScore)} text-white text-base px-3 py-1`}>
                                Risk: {caseFile.riskScore.toFixed(0)}%
                              </Badge>
                            </div>
                            <div className="text-base text-[#E2E8F0] mb-2">
                            ...
                            {caseFile.walletAddress && (
                              <div className="text-base text-[#E2E8F0] mb-2">
                                <span className="text-[#CFFAFE]">Wallet:</span> <span className="font-mono text-sm">{caseFile.walletAddress.substring(0, 20)}...</span>
                              </div>
                            )}
                            {caseFile.location && (
                              <div className="text-base text-[#E2E8F0] mb-2">
                ...
                <div className="bg-[#11243D] border-2 border-[#FBBF24]/30 rounded-[14px] p-6 mt-6">
          ...
          <TabsContent value="emergency" className="space-y-8">
            <Card className="bg-[#7F1D1D] border-[#EF4444] border-4 rounded-[14px] p-8 shadow-[0_0_20px_#EF4444]">
              <CardHeader className="pb-6">
                <CardTitle className="text-white text-2xl font-bold flex items-center gap-3">
                  <span>🚨</span>
              ...
              <CardContent className="space-y-6">
                ...
                <Button 
                  ...
                  className="w-full bg-[#EF4444] hover:bg-[#EF4444]/90 text-white font-bold text-2xl h-20 rounded-[12px] shadow-[0_0_20px_#EF4444] disabled:opacity-50"
                >
                ...
                <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[12px] p-6">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-[#CFFAFE] text-xl font-bold">System Status</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center gap-3 p-3 bg-[#132B45] rounded-lg">
                        <span className="text-2xl">🔕</span>
                        <div>
                          <div className="text-white font-bold">Vibrate</div>
                          <div className="text-[#A1A1AA] text-sm">Alert System</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-[#132B45] rounded-lg">
                        <span className="text-2xl">🛑</span>
                        <div>
                          <div className="text-white font-bold">Block</div>
                          <div className="text-[#A1A1AA] text-sm">Call Blocking</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-[#132B45] rounded-lg">
                        <span className="text-2xl">📵</span>
                        <div>
                          <div className="text-white font-bold">Hang Up</div>
                          <div className="text-[#A1A1AA] text-sm">Auto Disconnect</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-[#132B45] rounded-lg">
                        <span className="text-2xl">🔐</span>
                        <div>
                          <div className="text-white font-bold">Lock Wallet</div>
                          <div className="text-[#A1A1AA] text-sm">App Lockdown</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-[#132B45] rounded-lg">
                        <span className="text-2xl">⏳</span>
                        <div>
                          <div className="text-white font-bold">Delay</div>
                          <div className="text-[#A1A1AA] text-sm">Transfer Delay</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-[#132B45] rounded-lg">
                        <span className="text-2xl">📲</span>
                        <div>
                          <div className="text-white font-bold">Notify</div>
                          <div className="text-[#A1A1AA] text-sm">Family Alerts</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="bg-[#11243D] border-[#14B8A6]/30 border-2 rounded-[12px] p-6">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-[#CFFAFE] text-xl font-bold">Automatic Activation (Default ON)</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-white">
                      <div className="flex items-center gap-2">
                        <Badge className="bg-[#22C55E] text-white">✓</Badge>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between">
                      ...
                      <Button 
                        ...
                        className={`${travelModeActive ? 'bg-[#22C55E]' : 'bg-[#A1A1AA]'} hover:opacity-90 text-white font-bold h-12 px-6 rounded-[10px]`}
                      >
          ...
          <div className="bg-[#0A1A2F] border-2 border-[#14B8A6] rounded-[14px] max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-8">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-3xl font-bold text-white">🛡 Choose Your Protection</h2>
                <button 
                  onClick={() => setShowSubscriptionModal(false)}
                  className="text-[#A1A1AA] hover:text-white text-2xl"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {subscriptionTiers.length === 0 && (
                  <div className="col-span-3 text-center text-[#A1A1AA]">Loading subscription tiers...</div>
                )}
                {/* FREE Tier */}
                <div className="bg-[#11243D] border border-[#14B8A6]/30 rounded-[12px] p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-white mb-2">FREE</h3>
                    <div className="text-4xl font-bold text-[#14B8A6] mb-2">$0</div>
                    <div className="text-[#A1A1AA]">Forever</div>
                  </div>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Basic Scam Detection</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Single Wallet Risk Score</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">GPS Fraud Warnings</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Manual Freeze Mode</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">1 Case Report/month</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#A1A1AA] mt-1">✕</span>
                      <span className="text-[#A1A1AA] text-sm">No PDF Export</span>
                    </div>
                  </div>
                  <Button 
                    className="w-full bg-[#132B45] hover:bg-[#132B45]/80 text-white font-bold h-12"
                    disabled
                  >
                    Current Plan
                  </Button>
                ...
                {/* PREMIUM SHIELD Tier */}
                <div className="bg-gradient-to-b from-[#14B8A6]/20 to-[#11243D] border-2 border-[#14B8A6] rounded-[12px] p-6 relative">
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#14B8A6] text-[#0A1A2F] px-4 py-1 rounded-full text-sm font-bold">
                    RECOMMENDED
                  </div>
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-white mb-2">PREMIUM SHIELD</h3>
                    <div className="text-4xl font-bold text-[#14B8A6] mb-2">$9.99</div>
                    <div className="text-[#A1A1AA]">per month</div>
                  </div>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm font-bold">All FREE features PLUS:</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Real-time Voice Protection</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Emotional + Manipulation AI</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Auto Freeze Mode</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Unlimited Wallet Scanning</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Wallet Lineage Mapping</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Unlimited PDF Exports</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Scammer Profile Builder</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Case Timeline</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Family Center (3 members)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Travel Mode Protection</span>
                    </div>
                  </div>
                  <Button 
                    onClick={() => upgradeSubscription('premium_shield')}
                    className="w-full bg-[#14B8A6] hover:bg-[#14B8A6]/80 text-[#0A1A2F] font-bold h-12 shadow-[0_0_12px_#14B8A6]"
                  >
                    Upgrade to Premium
                  </Button>
                </div>
                ...
                {/* GUARDIAN ULTRA Tier */}
                <div className="bg-gradient-to-b from-purple-500/20 to-[#11243D] border-2 border-purple-500 rounded-[12px] p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-white mb-2">GUARDIAN ULTRA</h3>
                    <div className="text-4xl font-bold text-purple-400 mb-2">$19.99</div>
                    <div className="text-[#A1A1AA]">per month</div>
                  </div>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm font-bold">All PREMIUM features PLUS:</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Family Center (10 members)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Scammer Network Intelligence</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Voice Line-Up Tool</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Dark Web Monitoring</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                      <span className="text-white text-sm">Ultra Travel Mode</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <span className="text-[#22C55E] mt-1">✓</span>
                  ...
                  <Button 
                    ...
                    className="w-full bg-purple-500 hover:bg-purple-600 text-white font-bold h-12 shadow-[0_0_12px_rgb(168,85,247)]"
                  >
                    Go Ultra
                  </Button>
                </div>
              ...
              <div className="mt-8 text-center">
                ...
                <Button 
                  className="bg-[#132B45] hover:bg-[#132B45]/80 text-[#14B8A6] font-bold h-12 px-8"
                >
      ...
      {showPaywall && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#0A1A2F] border-2 border-[#EF4444] rounded-[14px] max-w-md w-full p-8">
            <div className="text-center mb-6">
              <div className="text-6xl mb-4">🔒</div>
              <h3 className="text-2xl font-bold text-white mb-4">Premium Feature</h3>
              {paywallFeature && (
                <p className="text-[#14B8A6] text-sm mb-2 font-mono">
                  Feature: {paywallFeature}
                </p>
              )}
              <p className="text-[#E2E8F0] text-base mb-2">
                {paywallMessage}
              </p>
            ...
            <div className="space-y-3">
              <Button 
                ...
                className="w-full bg-[#14B8A6] hover:bg-[#14B8A6]/80 text-[#0A1A2F] font-bold h-12"
              >
                View Plans & Upgrade
              </Button>
              <Button 
            ...
            {userSubscription && (
              <div className="mt-6 pt-6 border-t border-[#14B8A6]/30">
